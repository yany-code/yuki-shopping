...
public class CartController {
    ...
    @PostMapping("/items")
    public ApiResponse<?> add(@Valid @RequestBody ItemRequest r) {
        return ApiResponse.ok(r);
    }
    @PutMapping("/items/{id}")
    public ApiResponse<?> update(@PathVariable Long id, @Valid @RequestBody ItemRequest r) {
        return ApiResponse.ok(r);
    }
    ...
    public ApiResponse<?> checkAll(@RequestBody Map<String,Boolean> body) {
        return ApiResponse.ok();
    }
}
