...
public class AdminController{
    ...
    public ApiResponse<?> ship(@PathVariable String orderNo,@RequestBody Map<String,String> body){
    ...
    public ApiResponse<?> reviewStatus(@PathVariable Long id,@RequestBody Map<String,Integer> body){
        return ApiResponse.ok();
    }
}
